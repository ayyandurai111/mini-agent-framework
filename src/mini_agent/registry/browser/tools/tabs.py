...
class TabsTool(BaseTool):
    ...
    def run(self, action: str, tab_id: str = None,
        ...
        try:
            if action == "list":
                ...
                new_id = self.browser.open_tab(url)
                ...
                active = self.browser.close_tab(tab_id)
            ...
            return ToolResponse.fail(tool=self.name, message="Tab operation failed",
